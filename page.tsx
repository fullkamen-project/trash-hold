...
export default function AbiPage() {
  return (
    <main className="min-h-screen bg-base flex flex-col items-center justify-center relative overflow-hidden theme-abi">
      {/* Фоновое свечение в акцентном цвете темы ABI */}
      ...
      <div className="relative z-10 flex flex-col items-center p-6 text-center">
        ...
        <p className="text-text-muted text-sm tracking-[0.2em] uppercase mb-10 max-w-md">
          Раздел тактического симулятора находится в стадии сбора разведданных. Ожидайте обновления систем.
        </p>
