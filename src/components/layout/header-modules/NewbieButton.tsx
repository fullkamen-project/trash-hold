...
export default function NewbieButton({ onClick }: NewbieButtonProps) {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 flex h-[32px] w-[160px] -translate-y-1/2 items-center justify-center rounded bg-gradient-to-r from-[#222225] via-[#9CA3AF] to-[#222225] p-[1px] transition-colors duration-300 group-hover:via-[var(--primary)]">
        
        {/* 3. Внутренний фон кнопки (Строго #0D0D0F) */}
        <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[3px] bg-[#0D0D0F]">
          
          {/* Hazard-полоски (внутри корпуса по краям) */}
          <div className="absolute left-1 top-0 h-full w-1.5 opacity-40 transition-colors duration-300 text-text-secondary group-hover:text-[var(--primary)] group-hover:opacity-80 bg-[repeating-linear-gradient(-45deg,currentColor,currentColor_3px,transparent_3px,transparent_6px)]" />
          <div className="absolute right-1 top-0 h-full w-1.5 opacity-40 transition-colors duration-300 text-text-secondary group-hover:text-[var(--primary)] group-hover:opacity-80 bg-[repeating-linear-gradient(-45deg,currentColor,currentColor_3px,transparent_3px,transparent_6px)]" />
          ...
          <div className="absolute bottom-0 left-[14px] h-[28px] w-[26px]">
            {/* Start Frame */}
            <div 
              className="icon-mask absolute inset-0 text-[#9CA3AF] transition-opacity duration-300 group-hover:opacity-0"
            ...
            {/* End Frame */}
            <div 
              className="icon-mask absolute inset-0 opacity-0 text-[var(--primary)] transition-opacity duration-300 group-hover:opacity-100"
          ...
          <span className="relative z-10 font-blender-medium text-[12px] uppercase tracking-wide text-[#9CA3AF] transition-colors duration-300 group-hover:text-[var(--primary)]">
            Я НОВИЧОК
          </span>
