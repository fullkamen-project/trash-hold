  ...
  eft: {
    ...
    menuItems: [
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    id: 'i-guns-mods-critical',
                    label: 'Критические',
                    path: '/eft/items/guns/mods/critical',
                    iconUrl: '/icons/eft/03-items/guns/gun-modes/gear-mods.svg',
                    children: [
                      { id: 'i-mods-crit-gasblocks', label: 'Газовые трубки', path: '/eft/items/guns/mods/critical/gasblocks', iconUrl: '/icons/eft/03-items/guns/gun-modes/gas-blocks.svg' },
                      { id: 'i-mods-crit-receivers', label: 'Крышки и ресиверы', path: '/eft/items/guns/mods/critical/receivers', iconUrl: '/icons/eft/03-items/guns/gun-modes/receivers-slides.svg' },
                      { id: 'i-mods-crit-pistolgrips', label: 'Рукоятки', path: '/eft/items/guns/mods/critical/pistol-grips', iconUrl: '/icons/eft/03-items/guns/gun-modes/pistol-grips.svg' },
                      { id: 'i-mods-crit-barrels', label: 'Стволы', path: '/eft/items/guns/mods/critical/barrels', iconUrl: '/icons/eft/03-items/guns/gun-modes/barrels.svg' },
                      { id: 'i-mods-crit-handguards', label: 'Цевья', path: '/eft/items/guns/mods/critical/handguards', iconUrl: '/icons/eft/03-items/guns/gun-modes/handguards.svg' }
                    ]
                  },
                  {
      ...
      { 
        ...
        iconUrl: '/icons/eft/05-gamesetting/tarkov-lore.svg',
        children: [
      ...
      { 
        ...
        label: 'Видео', 
        path: '/eft/videos', 
        iconUrl: '/icons/eft/06-videos/videos-icon.svg',
        children: [
